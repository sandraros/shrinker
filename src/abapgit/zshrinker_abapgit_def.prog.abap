...
CLASS SHRITEFUH64VYIPO5I47WOOA5SVASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5SWASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5SXASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5SYASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5SZASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5S2ASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5S3ASM DEFINITION.
  PUBLIC SECTION.
    INTERFACES Lif_abapgit_ajson_mapping.
ENDCLASS.

CLASS SHRITEFUH64VYIPO5I47WOOA5S4ASM DEFINITION.
  PUBLIC SECTION.
    INTERFACES Lif_abapgit_ajson_mapping.
    METHODS constructor
      IMPORTING
...
CLASS SHRITEFUH64VYIPO5I47WOOA5VRASM DEFINITION FINAL.
  PUBLIC SECTION.
...
*include zcl_abapgit_git_pack==========ci.
  PRIVATE SECTION.
    ...
    CLASS-METHODS delta_header
      IMPORTING
        !io_stream       TYPE REF TO SHRITEFUH64VYIPO5I47WOOA5VRASM
      RETURNING
...
INTERFACE SHRITEFUH64VYIPO5I47WOOA52XASM.
...
CLASS SHRITEFUH64VYIPO5I47WOOA52YASM DEFINITION.

  PUBLIC SECTION.
    INTERFACES:
      SHRITEFUH64VYIPO5I47WOOA52XASM.
  ...
  PRIVATE SECTION.
    ...
    METHODS create_or_load
      IMPORTING
        ...
        !iv_package         TYPE devclass
      RETURNING
        VALUE(ri_interface) TYPE REF TO SHRITEFUH64VYIPO5I47WOOA52XASM
      RAISING
        Lcx_abapgit_exception .
    METHODS delete_elements
      IMPORTING
        !ii_interface TYPE REF TO SHRITEFUH64VYIPO5I47WOOA52XASM
      RAISING
        Lcx_abapgit_exception .
    ...
    METHODS create_facade
      IMPORTING
        ii_interface     TYPE REF TO if_package_interface
      RETURNING
        VALUE(ri_facade) TYPE REF TO SHRITEFUH64VYIPO5I47WOOA52XASM.
...
TYPES:
  BEGIN OF SHRITEFUH64VYIPO5I47WOOA5XDASM,
    path        TYPE string,
    filename    TYPE string,
    remote_sha1 TYPE Lif_abapgit_git_definitions=>ty_sha1,
    local_sha1  TYPE Lif_abapgit_git_definitions=>ty_sha1,
  END OF SHRITEFUH64VYIPO5I47WOOA5XDASM.
TYPES:
  SHRITEFUH64VYIPO5I47WOOA5XFASM TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WOOA5XDASM WITH UNIQUE KEY path filename.

TYPES: BEGIN OF SHRITEFUH64VYIPO5I47WOOA5XGASM,
         BEGIN OF repo,
           name    TYPE string,
         ...
         changed_files   TYPE SHRITEFUH64VYIPO5I47WOOA5XFASM,
         changed_objects TYPE Lif_abapgit_definitions=>ty_items_ts,
       END OF SHRITEFUH64VYIPO5I47WOOA5XGASM.
TYPES SHRITEFUH64VYIPO5I47WOOA5XHASM TYPE STANDARD TABLE OF SHRITEFUH64VYIPO5I47WOOA5XGASM WITH DEFAULT KEY.
  ...
  PRIVATE SECTION.
    ...
    CONSTANTS:
      BEGIN OF c_action,
        ...
        stage   TYPE string VALUE 'stage',
      END OF c_action .
    DATA mt_features TYPE SHRITEFUH64VYIPO5I47WOOA5XHASM .
    ...
    METHODS render_table
      IMPORTING
        !iv_index      TYPE i
        !is_feature    TYPE SHRITEFUH64VYIPO5I47WOOA5XGASM
      RETURNING
        VALUE(ri_html) TYPE REF TO Lif_abapgit_html .
...
INTERFACE SHRITEFUH64VYIPO5I47WOOA52IASM.
...
*include zcl_abapgit_object_pdts=======ci.
  PRIVATE SECTION.
    ...
    METHODS get_container_xml IMPORTING ii_task                 TYPE REF TO SHRITEFUH64VYIPO5I47WOOA52IASM
