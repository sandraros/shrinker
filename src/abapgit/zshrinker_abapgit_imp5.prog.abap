...
*CLASS zcl_abapgit_longtexts DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA5ZAASM.
...
*----------------------------------------------------------------------*
*       CLASS SHRITEFUH64VYIPO5I47WOOA5ZKASM DEFINITION
*----------------------------------------------------------------------*
*
*----------------------------------------------------------------------*

*----------------------------------------------------------------------*
*       CLASS SHRITEFUH64VYIPO5I47WOOA5ZKASM IMPLEMENTATION
*----------------------------------------------------------------------*
*
*----------------------------------------------------------------------*
...
*CLASS zcl_abapgit_objects DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA5ZOASM.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5Z4ASM DEFINITION.
  PUBLIC SECTION.
    CLASS-METHODS:
...
CLASS SHRITEFUH64VYIPO5I47WOOA5Z4ASM IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5Z6ASM DEFINITION.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA5Z6ASM IMPLEMENTATION.
  ...
  METHOD Lif_abapgit_aff_type_mapping~to_aff.
    ...
    " get descriptions
    ls_data_aff-descriptions = SHRITEFUH64VYIPO5I47WOOA5Z4ASM=>get_descriptions_compo_subco(
...
CLASS SHRITEFUH64VYIPO5I47WOOA52AASM DEFINITION.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA52AASM IMPLEMENTATION.
  ...
  METHOD serialize.
    ...
    CREATE OBJECT lo_aff_mapper TYPE SHRITEFUH64VYIPO5I47WOOA5Z6ASM.
...
*CLASS SHRITEFUH64VYIPO5I47WOOA52CASM DEFINITION DEFERRED.
*CLASS zcl_abapgit_object_intf DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA52CASM.
...
*include methods.
  ...
  METHOD read_json.
    ...
    ls_intf_aff = SHRITEFUH64VYIPO5I47WOOA52AASM=>deserialize( lv_json_data ).
  ...
  METHOD serialize_xml.
    ...
    IF mv_aff_enabled = abap_true.
      lv_serialized_data = SHRITEFUH64VYIPO5I47WOOA52AASM=>serialize( ls_intf ).
...
*CLASS zcl_abapgit_object_tran DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA524ASM.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53DASM DEFINITION INHERITING FROM Lcl_abapgit_objects_program FINAL.
  PUBLIC SECTION.
    CLASS-METHODS new
      RETURNING
        VALUE(ro_instance) TYPE REF TO SHRITEFUH64VYIPO5I47WOOA53DASM.
    METHODS get_own_cua
      RETURNING
...
CLASS SHRITEFUH64VYIPO5I47WOOA53DASM IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53FASM DEFINITION FINAL.
  PUBLIC SECTION.
    CLASS-METHODS get
      RETURNING
...
CLASS SHRITEFUH64VYIPO5I47WOOA53FASM IMPLEMENTATION.
  METHOD get.
...
*include methods.
  METHOD gui_status_create.
    ...
    ls_cua = SHRITEFUH64VYIPO5I47WOOA53FASM=>get( ).
    ...
    TRY.
        SHRITEFUH64VYIPO5I47WOOA53DASM=>new( )->put_own_cua( ls_cua ).
      CATCH Lcx_abapgit_exception.
    ENDTRY.
  ...
  METHOD gui_status_exists.
    ...
    TRY.
        ls_own_cua = SHRITEFUH64VYIPO5I47WOOA53DASM=>new( )->get_own_cua( ).
      CATCH Lcx_abapgit_exception.
    ENDTRY.
    ...
    ls_new_cua = SHRITEFUH64VYIPO5I47WOOA53FASM=>get( ).
...
CLASS SHRITEFUH64VYIPO5I47WOOA53OASM DEFINITION
  FINAL
  CREATE PUBLIC .
...
CLASS SHRITEFUH64VYIPO5I47WOOA53OASM IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53QASM DEFINITION
  FINAL
  CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53QASM IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53VASM DEFINITION FINAL.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53VASM IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53XASM DEFINITION FINAL.
  PUBLIC SECTION.
    DATA mt_tab TYPE Lif_abapgit_definitions=>ty_files_item_tt.
    METHODS add IMPORTING iv_str TYPE string.
ENDCLASS.

CLASS SHRITEFUH64VYIPO5I47WOOA53XASM IMPLEMENTATION.
  METHOD add.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53ZASM DEFINITION FINAL.
  PUBLIC SECTION.
    DATA mt_tab TYPE Lif_abapgit_git_definitions=>ty_files_tt.
    METHODS add IMPORTING iv_str TYPE string.
ENDCLASS.

CLASS SHRITEFUH64VYIPO5I47WOOA53ZASM IMPLEMENTATION.
  METHOD add.
    DATA ls_item LIKE LINE OF mt_tab.
    DATA lv_tmp TYPE string.
    lv_tmp = iv_str.
...
CLASS SHRITEFUH64VYIPO5I47WOOA533ASM DEFINITION FINAL.
  PUBLIC SECTION.
    DATA mt_tab TYPE Lif_abapgit_git_definitions=>ty_file_signatures_tt.
    METHODS add IMPORTING iv_str TYPE string.
ENDCLASS.

CLASS SHRITEFUH64VYIPO5I47WOOA533ASM IMPLEMENTATION.
  METHOD add.
    DATA ls_item LIKE LINE OF mt_tab.
    DATA lv_tmp TYPE string.
    lv_tmp = iv_str.
...
*include methods.
  ...
  METHOD save_checksums.
    ...
    lv_cs_blob = SHRITEFUH64VYIPO5I47WOOA53OASM=>serialize( it_checksums ).
  ...
  METHOD Lif_abapgit_repo_checksums~get.
    ...
    IF lv_cs_blob IS NOT INITIAL.
      ...
      rt_checksums = SHRITEFUH64VYIPO5I47WOOA53OASM=>deserialize( lv_cs_blob ).
    ENDIF.
  ...
  METHOD Lif_abapgit_repo_checksums~update.
    ...
    lt_checksums = SHRITEFUH64VYIPO5I47WOOA53QASM=>calculate_updated(
...
CLASS SHRITEFUH64VYIPO5I47WOOA54CASM DEFINITION FINAL.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA54CASM IMPLEMENTATION.
...
*CLASS SHRITEFUH64VYIPO5I47WOOA54EASM DEFINITION DEFERRED.
*CLASS zcl_abapgit_repo_status DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA54EASM.





CLASS SHRITEFUH64VYIPO5I47WOOA54IASM DEFINITION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA54IASM IMPLEMENTATION.
...
*CLASS SHRITEFUH64VYIPO5I47WOOA54KASM DEFINITION DEFERRED.
*CLASS zcl_abapgit_repo_status DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA54KASM.



*CLASS SHRITEFUH64VYIPO5I47WOOA54MASM DEFINITION DEFERRED.
*CLASS zcl_abapgit_repo_status DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA54MASM.
...
*include methods.
  ...
  METHOD calculate.
    ...
    DATA lo_consistency_checks TYPE REF TO SHRITEFUH64VYIPO5I47WOOA54CASM.
...
*CLASS SHRITEFUH64VYIPO5I47WOOA542ASM DEFINITION DEFERRED.
*CLASS zcl_abapgit_serialize DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPO5I47WOOA542ASM.
...
CLASS SHRITEFUH64VYIPO5I47WOOA56IASM DEFINITION FINAL.
  PUBLIC SECTION.
    INTERFACES Lif_abapgit_gui_services.
    CLASS-METHODS create
      RETURNING
        VALUE(ro_instance) TYPE REF TO SHRITEFUH64VYIPO5I47WOOA56IASM.
ENDCLASS.

CLASS SHRITEFUH64VYIPO5I47WOOA56IASM IMPLEMENTATION.
  METHOD create.
    CREATE OBJECT ro_instance.
  ENDMETHOD.
...
*include methods.
  METHOD get_dummy_gui_services.
    ...
    ri_gui_services = SHRITEFUH64VYIPO5I47WOOA56IASM=>create( ).
...
CLASS SHRITEFUH64VYIPO5I47WOOA53JASM DEFINITION FINAL.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPO5I47WOOA53JASM IMPLEMENTATION.
...
* versions since 702, so show an error
  ...
  METHOD Lif_abapgit_popups~popup_to_select_from_list.
    ...
    DATA lo_popup TYPE REF TO SHRITEFUH64VYIPO5I47WOOA53JASM.
