...
********************************************************************************
  METHOD create_facade.
    ...
    CREATE OBJECT ri_facade TYPE SHRITEFUH64VYIPN5I4UHL45BMCR4A
      EXPORTING
...
* it fail for local($) packages
  ...
  METHOD Lif_abapgit_object~delete.
    ...
    DATA: li_interface TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BMBR4A.
...
* can be deleted
  ...
  METHOD Lif_abapgit_object~serialize.
    ...
    DATA: ls_pinf      TYPE ty_pinf,
          ...
          li_interface TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BMBR4A.
...
*CLASS SHRITEFUH64VYIPN5I4UHL45BMHR4A DEFINITION DEFERRED.
*CLASS zcl_abapgit_oo_serializer DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BMHR4A.
...
*CLASS zcl_abapgit_po_file DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BMVR4A.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BPMR4A DEFINITION FINAL.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BPMR4A IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BPOR4A DEFINITION FINAL.
  PUBLIC SECTION.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BPOR4A IMPLEMENTATION.
...
*include methods.
  METHOD run.
    ...
    DATA:
      ...
      lo_transport_zipper TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BPOR4A,
    ...
    TRY.
        ...
        lt_trkorr = SHRITEFUH64VYIPN5I4UHL45BPMR4A=>select_tr_requests( ).

        IF lt_trkorr[] IS NOT INITIAL.

          lv_folder = SHRITEFUH64VYIPN5I4UHL45BPMR4A=>f4_folder( ).
...
* Instantiate transport zipper object that will also create the timestamped output folder
          CREATE OBJECT lo_transport_zipper TYPE SHRITEFUH64VYIPN5I4UHL45BPOR4A
            EXPORTING
              iv_folder = lv_folder.
...
* Open output folder if user asked it
          SHRITEFUH64VYIPN5I4UHL45BPMR4A=>open_folder_frontend( lo_transport_zipper->get_folder( ) ).
...
*CLASS SHRITEFUH64VYIPN5I4UHL45BQIR4A DEFINITION DEFERRED.
*CLASS zcl_abapgit_xml_output DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BQIR4A.
...
*CLASS SHRITEFUH64VYIPN5I4UHL45BQWR4A DEFINITION DEFERRED.
*CLASS SHRITEFUH64VYIPN5I4UHL45BQXR4A DEFINITION DEFERRED.
*CLASS zcx_abapgit_exception DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BQWR4A SHRITEFUH64VYIPN5I4UHL45BQXR4A.
...
*CLASS zcl_abapgit_gui_page_patch DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BIZR4A.
...
*CLASS SHRITEFUH64VYIPN5I4UHL45BKZR4A DEFINITION DEFERRED.
*CLASS zcl_abapgit_objects_activation DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BKZR4A.
...
*CLASS zcl_abapgit_objects_program DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BLAR4A.
...
*CLASS zcl_abapgit_object_common_aff DEFINITION LOCAL FRIENDS SHRITEFUH64VYIPN5I4UHL45BLBR4A.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BLTR4A DEFINITION
...
CLASS SHRITEFUH64VYIPN5I4UHL45BLTR4A IMPLEMENTATION.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BLVR4A DEFINITION
  CREATE PUBLIC
  FINAL.

  PUBLIC SECTION.

    INTERFACES SHRITEFUH64VYIPN5I4UHL45BLSR4A.

    CLASS-METHODS load IMPORTING iv_objid         TYPE hrobject-objid
                       RETURNING VALUE(ri_result) TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLSR4A
                       RAISING   Lcx_abapgit_exception.

    CLASS-METHODS create IMPORTING iv_objid         TYPE hrobject-objid
                                   is_task_data     TYPE SHRITEFUH64VYIPN5I4UHL45BLSR4A=>ty_task_data
                         RETURNING VALUE(ri_result) TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLSR4A
                         RAISING   Lcx_abapgit_exception.
  ...
  PRIVATE SECTION.
    ...
    DATA ms_task TYPE SHRITEFUH64VYIPN5I4UHL45BLSR4A=>ty_task_data.
...
CLASS SHRITEFUH64VYIPN5I4UHL45BLVR4A IMPLEMENTATION.

  METHOD load.

    DATA lo_taskdef TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLVR4A.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~clear_origin_data.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~get_definition.
    rs_result = me->ms_task.
  ENDMETHOD.

  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~get_container.
    ri_result = mo_taskdef->container.
  ENDMETHOD.

  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~get_user_container.
  ...
  METHOD create.
    DATA lo_task TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLVR4A.

    CREATE OBJECT lo_task TYPE SHRITEFUH64VYIPN5I4UHL45BLVR4A.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~import_container.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~create_task.
    ...
    SHRITEFUH64VYIPN5I4UHL45BLTR4A=>set_objid( iv_objid = mv_objid
                                           io_task  = mo_taskdef ).

    SHRITEFUH64VYIPN5I4UHL45BLTR4A=>set_container_id( iv_id    = |TS{ mv_objid }|
                                            io_task  = mo_taskdef ).

  ENDMETHOD.

  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~change_start_events.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~save.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~change_wi_text.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~change_method.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~change_terminating_events.
  ...
  METHOD SHRITEFUH64VYIPN5I4UHL45BLSR4A~change_text.
...
*include methods.
  ...
  METHOD Lif_abapgit_object~deserialize.
    ...
    DATA: ls_task       TYPE SHRITEFUH64VYIPN5I4UHL45BLSR4A=>ty_task_data,
          lv_xml_string TYPE xstring,
          li_task       TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLSR4A.

    io_xml->read( EXPORTING iv_name = 'PDTS'
      CHANGING cg_data = ls_task ).

    li_task = SHRITEFUH64VYIPN5I4UHL45BLVR4A=>create(
                      iv_objid     = mv_objid
  ...
  METHOD Lif_abapgit_object~serialize.
    ...
    DATA li_task TYPE REF TO SHRITEFUH64VYIPN5I4UHL45BLSR4A.

    li_task = SHRITEFUH64VYIPN5I4UHL45BLVR4A=>load( mv_objid ).
