...
*    DATA range_all_objects TYPE zcl_shrinker_copy_objects=>ty_range_of_obj_name .
...
*        me->program_name = get_main_program_name( object   = object
*                                                  obj_name = obj_name ).
...
*        ENDIF.
*
*        replace_includes( EXPORTING program_name = program_name
