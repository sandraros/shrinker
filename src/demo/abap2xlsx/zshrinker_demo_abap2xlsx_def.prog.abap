...
*--------------------------------------------------------------------*
* CLASS SHRITEFUH64VYIPO5I47WC2YA5DAQQ
*--------------------------------------------------------------------*
* use for method bind_ALV
*--------------------------------------------------------------------*
CLASS SHRITEFUH64VYIPO5I47WC2YA5DAQQ DEFINITION.
  PUBLIC SECTION.
...
ENDCLASS.                    "SHRITEFUH64VYIPO5I47WC2YA5DAQQ DEFINITION
*class-pool .
...
TYPES SHRITEFUH64VYIPO5I47WC2YA4QAQQ TYPE c LENGTH 1.

TYPES:   BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4TAQQ,
           seoclass   TYPE seoclsname,
           clsname    TYPE seoclsname,
         END OF SHRITEFUH64VYIPO5I47WC2YA4TAQQ,
         tt_alv_types TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4TAQQ WITH UNIQUE KEY seoclass.

TYPES:   BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4UAQQ,
         ...
         END OF SHRITEFUH64VYIPO5I47WC2YA4UAQQ,

         tt_sort_values TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4UAQQ WITH UNIQUE KEY fieldname.
TYPES:   BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4VAQQ,
            row_int        TYPE zexcel_cell_row,
            row_int_start  TYPE zexcel_cell_row,
            columnname     TYPE fieldname,
         END OF SHRITEFUH64VYIPO5I47WC2YA4VAQQ,

         tt_subtotal_rows TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4VAQQ WITH UNIQUE KEY row_int.

TYPES:   BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4WAQQ,
            type         TYPE SHRITEFUH64VYIPO5I47WC2YA4QAQQ,
            alignment    TYPE zexcel_alignment,
            inttype      TYPE abap_typekind,
            decimals     TYPE int1,
            style        TYPE REF TO Lcl_excel_style,
            guid         TYPE zexcel_cell_style,
         END OF SHRITEFUH64VYIPO5I47WC2YA4WAQQ,

         tt_styles TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4WAQQ  WITH UNIQUE KEY type alignment inttype decimals.

TYPES:   BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4XAQQ,
         ...
         END OF SHRITEFUH64VYIPO5I47WC2YA4XAQQ,

         tt_color_styles TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4XAQQ  WITH UNIQUE KEY guid_old fontcolor fillcolor.
...
*include Lcl_excel_converter===========ci.
  PRIVATE SECTION.
    ...
    METHODS get_style
      IMPORTING
        !i_type        TYPE SHRITEFUH64VYIPO5I47WC2YA4QAQQ
...
*"* definitions, interfaces or data types) you need for method
*"* implementation or private method's signature
TYPES: BEGIN OF SHRITEFUH64VYIPO5I47WC2YA4YAQQ,
           col       TYPE lvc_col,
           int       TYPE lvc_int,
           inv       TYPE lvc_inv,
           fontcolor TYPE zexcel_style_color_argb,
           fillcolor TYPE zexcel_style_color_argb,
       END OF SHRITEFUH64VYIPO5I47WC2YA4YAQQ,

       tt_col_converter TYPE HASHED TABLE OF SHRITEFUH64VYIPO5I47WC2YA4YAQQ WITH UNIQUE KEY col int inv.
...
*
CLASS SHRITEFUH64VYIPO5I47WC2YA55AQQ DEFINITION ABSTRACT.
  PUBLIC SECTION.
...
*include Lcl_excel_reader_2007=========ci.
  PRIVATE SECTION.
    ...
    DATA zip TYPE REF TO SHRITEFUH64VYIPO5I47WC2YA55AQQ .
    DATA: gid TYPE i.
    ...
    METHODS create_zip_archive
      ...
      RETURNING
        VALUE(e_zip)         TYPE REF TO SHRITEFUH64VYIPO5I47WC2YA55AQQ
      RAISING
        Lcx_excel .
...
CLASS SHRITEFUH64VYIPO5I47WC2YA6EAQQ DEFINITION DEFERRED.
*class-pool .
...
*public
  CREATE PUBLIC
FRIENDS
SHRITEFUH64VYIPO5I47WC2YA6EAQQ
...
CLASS SHRITEFUH64VYIPO5I47WC2YA45AQQ DEFINITION INHERITING FROM cx_static_check.
  PUBLIC SECTION.
    DATA error TYPE string.
    METHODS constructor
...
*include Lcl_excel_reader_huge_file====ci.
  PRIVATE SECTION.
    ...
    METHODS skip_to
      ...
      RAISING
        SHRITEFUH64VYIPO5I47WC2YA45AQQ .
